...
<a href="<s:url value="/admin/lessons/"/>">Back</a>
<h1>Create lesson</h1>
<div>
	<div>
		<s:form action="/admin/lessons/create">
			...
			<s:select label="User" headerKey="-1" headerValue="Select User"
				list="users" listKey="userId" listValue="username"
				name="lesson.user.userId" />
